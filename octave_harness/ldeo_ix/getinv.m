...
A1o=A1;
A2o=A2;
% NOTE(octave_harness): `do` renamed to `d_orig` -- reserved keyword in
% Octave (do-until), valid identifier in MATLAB. The struct field name
% de.do below is untouched (field names aren't keyword-restricted).
d_orig=d;
