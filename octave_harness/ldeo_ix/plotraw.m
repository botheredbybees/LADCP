...
% NOTE(octave_harness): parameter renamed from `do` -- reserved keyword in
% Octave (do-until), valid identifier in MATLAB. Call sites use positional
% args only, so this rename is local to the function body.
